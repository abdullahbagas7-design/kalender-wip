...
const Navigation = ({ currentView, onViewChange, onAddClick }: NavigationProps) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pb-6 px-4">
      <div className="max-w-md mx-auto glass rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-2">
        <div className="grid grid-cols-3 gap-1">
          ...
          <button
            onClick={onAddClick}
            className="flex flex-col items-center justify-center py-3 rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-700 text-white shadow-lg hover:scale-105 transition-all duration-200 active:scale-95"
          >
